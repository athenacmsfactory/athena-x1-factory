...
- **Engine Kern (`/factory/factory/5-engine/`):** Bevat alle actieve scripts en wizards.
...
- **TSV Sync:** `node factory/5-engine/sync-tsv-to-json.js [site-name]`
...
- **Onboarding Wizard:** `node factory/5-engine/onboarding-wizard.js`
  - *Wat het doet:* Begeleid proces voor nieuwe klanten/projecten.
- **Site Wizard:** `node factory/5-engine/site-wizard.js`
...
- **MCP Helper:** `node factory/5-engine/athena-mcp-helper.js [wizard] [antwoorden...]`
...
- **Status Dashboard:** `node factory/5-engine/generate-sites-overview.js`
