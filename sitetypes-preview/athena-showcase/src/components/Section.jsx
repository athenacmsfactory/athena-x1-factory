...
/* {{IMPORTS_START}} */
import header_0 from './HeaderV9';
import hero_1 from './HeroLegoV9';
import contact_5 from './ContactLegoV9';
import footer_6 from './FooterV9';
/* {{IMPORTS_END}} */
...
const Section = ({ data }) => {
  ...
  const getComponent = (sectionName) => {
      ...
      /* {{MAPPING_START}} */
      if (lower === 'header') return header_0;
      if (lower === 'hero') return hero_1;
      if (lower === 'contact') return contact_5;
      if (lower === 'footer') return footer_6;
/* {{MAPPING_END}} */
