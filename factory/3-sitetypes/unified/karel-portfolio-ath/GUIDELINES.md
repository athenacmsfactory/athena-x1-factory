...
- Gebruik altijd de V10 `data-dock-type` en `data-dock-bind` attributen op standaard HTML elementen (`img`, `span`, `div`) voor volledige Dock-compatibiliteit. De legacy `Editable*` componenten zijn gedeprecieerd.
